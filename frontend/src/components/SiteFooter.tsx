				...
				<div className="row text-center align-items-center flex-row-reverse">
					<div className="col-lg-auto ms-lg-auto">
						<ul className="list-inline list-inline-dots mb-0">
							<li className="list-inline-item">
								<a
									href="https://github.com/eduardofbrito/haproxy-proxy-manager"
									target="_blank"
					...
					<div className="col-12 col-lg-auto mt-3 mt-lg-0">
						<ul className="list-inline list-inline-dots mb-0">
							...
							<li className="list-inline-item">
								<a
									href={`https://github.com/eduardofbrito/haproxy-proxy-manager/releases/tag/${getVersion()}`}
									className="link-secondary"
									target="_blank"
									rel="noopener"
								>
							...
							{versionData?.updateAvailable && versionData?.latest && (
								<li className="list-inline-item">
									<a
										href={`https://github.com/eduardofbrito/haproxy-proxy-manager/releases/tag/${versionData.latest}`}
