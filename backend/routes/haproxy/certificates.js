	...
	.post(async (req, res, next) => {
		try {
			const payload = await apiValidator(
				getValidationSchema("/haproxy/certificates", "post"),
				req.body,
			);
...
/**
 * /api/haproxy/certificates/dns-providers
 */
router
	.route("/dns-providers")
	.options((_, res) => {
	...
	/**
	 * GET /api/haproxy/certificates/dns-providers
	 *
 ...
 *
 * /api/haproxy/certificates/test-http
 */
router
	.route("/test-http")
	.options((_, res) => {
	...
	/**
	 * POST /api/haproxy/certificates/test-http
	 *
	 * Test HTTP challenge for domains
	 */
	.post(async (req, res, next) => {
		try {
			const payload = await apiValidator(
				getValidationSchema("/haproxy/certificates/test-http", "post"),
				req.body,
			);
 ...
 *
 * /api/haproxy/certificates/validate
 */
router
	.route("/validate")
	.options((_, res) => {
	...
	/**
	 * POST /api/haproxy/certificates/validate
	 *
...
router
	...
	/**
	 * GET /api/haproxy/certificates/123
	 *
	...
	/**
	 * DELETE /api/haproxy/certificates/123
	 *
 ...
 * Upload Certs
 *
 * /api/haproxy/certificates/123/upload
 */
router
	...
	/**
	 * POST /api/haproxy/certificates/123/upload
	 *
	 * Upload certificates
	 */
	.post(async (req, res, next) => {
 ...
 * Renew LE Certs
 *
 * /api/haproxy/certificates/123/renew
 */
router
	...
	/**
	 * POST /api/haproxy/certificates/123/renew
	 *
	 * Renew certificate
	 */
	.post(async (req, res, next) => {
 ...
 * Download LE Certs
 *
 * /api/haproxy/certificates/123/download
 */
router
	...
	/**
	 * GET /api/haproxy/certificates/123/download
	 *
	 * Renew certificate
	 */
	.get(async (req, res, next) => {
