...
router
	...
	/**
	 * POST /api/haproxy/streams
	 *
	 * Create a new stream
	 */
	.post(async (req, res, next) => {
		try {
			const payload = await apiValidator(getValidationSchema("/haproxy/streams", "post"), req.body);
...
router
	...
	/**
	 * PUT /api/haproxy/streams/123
	 *
	 * Update and existing stream
	 */
	.put(async (req, res, next) => {
		try {
			const payload = await apiValidator(getValidationSchema("/haproxy/streams/{streamID}", "put"), req.body);
	...
	/**
	 * DELETE /api/haproxy/streams/123
	 *
	 * Update and existing stream
	 */
 ...
 * Enable stream
 *
 * /api/haproxy/streams/123/enable
 */
router
	...
	/**
	 * POST /api/haproxy/streams/123/enable
	 */
	.post(async (req, res, next) => {
		try {
 ...
 * Disable stream
 *
 * /api/haproxy/streams/123/disable
 */
router
	...
	/**
	 * POST /api/haproxy/streams/123/disable
	 */
	.post(async (req, res, next) => {
		try {
