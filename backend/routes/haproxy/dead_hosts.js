...
router
	...
	/**
	 * POST /api/haproxy/dead-hosts
	 *
	 * Create a new dead-host
	 */
	.post(async (req, res, next) => {
		try {
			const payload = await apiValidator(getValidationSchema("/haproxy/dead-hosts", "post"), req.body);
...
router
	...
	/**
	 * GET /api/haproxy/dead-hosts/123
	 *
	...
	/**
	 * PUT /api/haproxy/dead-hosts/123
	 *
	 * Update an existing dead-host
	 */
	.put(async (req, res, next) => {
		try {
			const payload = await apiValidator(getValidationSchema("/haproxy/dead-hosts/{hostID}", "put"), req.body);
	...
	/**
	 * DELETE /api/haproxy/dead-hosts/123
	 *
	 * Delete a dead-host
	 */
 ...
 * Enable dead-host
 *
 * /api/haproxy/dead-hosts/123/enable
 */
router
	...
	/**
	 * POST /api/haproxy/dead-hosts/123/enable
	 */
	.post(async (req, res, next) => {
		try {
 ...
 * Disable dead-host
 *
 * /api/haproxy/dead-hosts/123/disable
 */
router
	...
	/**
	 * POST /api/haproxy/dead-hosts/123/disable
	 */
	.post((req, res, next) => {
		try {
