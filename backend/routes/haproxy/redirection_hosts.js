...
router
	...
	/**
	 * GET /api/haproxy/redirection-hosts
	 *
	...
	/**
	 * POST /api/haproxy/redirection-hosts
	 *
	 * Create a new redirection-host
	 */
	.post(async (req, res, next) => {
		try {
			const payload = await apiValidator(getValidationSchema("/haproxy/redirection-hosts", "post"), req.body);
 ...
 *
 * /api/haproxy/redirection-hosts/123
 */
router
	.route("/:host_id")
	.options((_, res) => {
	...
	/**
	 * GET /api/haproxy/redirection-hosts/123
	 *
	...
	/**
	 * PUT /api/haproxy/redirection-hosts/123
	 *
	...
	.put(async (req, res, next) => {
		try {
			const payload = await apiValidator(
				getValidationSchema("/haproxy/redirection-hosts/{hostID}", "put"),
				req.body,
			);
	...
	/**
	 * DELETE /api/haproxy/redirection-hosts/123
	 *
	 * Update and existing redirection-host
	 */
 ...
 *
 * /api/haproxy/redirection-hosts/123/enable
 */
router
	...
	/**
	 * POST /api/haproxy/redirection-hosts/123/enable
	 */
	.post(async (req, res, next) => {
		try {
 ...
 *
 * /api/haproxy/redirection-hosts/123/disable
 */
router
	...
	/**
	 * POST /api/haproxy/redirection-hosts/123/disable
	 */
	.post(async (req, res, next) => {
		try {
