...
router
	...
	/**
	 * POST /api/haproxy/access-lists
	 *
	 * Create a new access-list
	 */
	.post(async (req, res, next) => {
		try {
			const payload = await apiValidator(getValidationSchema("/haproxy/access-lists", "post"), req.body);
...
router
	...
	/**
	 * GET /api/haproxy/access-lists/123
	 *
	...
	/**
	 * PUT /api/haproxy/access-lists/123
	 *
	 * Update and existing access-list
	 */
	.put(async (req, res, next) => {
		try {
			const payload = await apiValidator(getValidationSchema("/haproxy/access-lists/{listID}", "put"), req.body);
	...
	/**
	 * DELETE /api/haproxy/access-lists/123
	 *
