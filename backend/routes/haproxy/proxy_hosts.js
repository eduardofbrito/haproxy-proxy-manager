...
router
	...
	/**
	 * POST /api/haproxy/proxy-hosts
	 *
	 * Create a new proxy-host
	 */
	.post(async (req, res, next) => {
		try {
			const payload = await apiValidator(getValidationSchema("/haproxy/proxy-hosts", "post"), req.body);
...
router
	...
	/**
	 * GET /api/haproxy/proxy-hosts/123
	 *
	...
	/**
	 * PUT /api/haproxy/proxy-hosts/123
	 *
	 * Update and existing proxy-host
	 */
	.put(async (req, res, next) => {
		try {
			const payload = await apiValidator(getValidationSchema("/haproxy/proxy-hosts/{hostID}", "put"), req.body);
	...
	/**
	 * DELETE /api/haproxy/proxy-hosts/123
	 *
	 * Update and existing proxy-host
	 */
 ...
 * Enable proxy-host
 *
 * /api/haproxy/proxy-hosts/123/enable
 */
router
	...
	/**
	 * POST /api/haproxy/proxy-hosts/123/enable
	 */
	.post(async (req, res, next) => {
		try {
 ...
 * Disable proxy-host
 *
 * /api/haproxy/proxy-hosts/123/disable
 */
router
	...
	/**
	 * POST /api/haproxy/proxy-hosts/123/disable
	 */
	.post(async (req, res, next) => {
		try {
